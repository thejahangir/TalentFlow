...
export default function JobSetupOverviewPage() {
 ...
 <label className="block text-xs font-bold text-black ">Job Title</label>
 ...
 <div>
 <label className="block text-xs font-bold text-black mb-2">Department</label>
 <input 
 type="text" 
 ...
 <div>
 <label className="block text-xs font-bold text-black mb-2">Requisition Ref</label>
 <input 
 type="text" 
 ...
 <div className="space-y-6">
 <div>
 <label className="block text-xs font-bold text-black mb-2">Headcount Required</label>
 ...
 <div className="pt-2">
 <label className="block text-xs font-bold text-black mb-2 flex justify-between">
 ...
 <div className="space-y-5">
 <div>
 <label className="block text-xs font-bold text-black mb-2">Location</label>
 <input 
 type="text" 
 ...
 <div className="grid grid-cols-2 gap-4">
 <div>
 <label className="block text-xs font-bold text-black mb-2">Employment Type</label>
 <SearchableSelect 
 options={[
 ...
 <div>
 <label className="block text-xs font-bold text-black mb-2">Work Mode</label>
 <SearchableSelect 
 options={[
